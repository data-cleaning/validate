...
Besides this, there are a number of functions that perform a particular
validation task.  These will be treated extensively in Chapters
\@ref(sect:varlevelchecks) to \@ref(sect:statisticalchecks), but here is a 
quick overview.
