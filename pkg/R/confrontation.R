...
#' it. It is the parent object of classes \code{\link{indication}} and
...
#' @section Details:
#' An \code{indication} stores a set of results generated by evaluating
#' an \code{\link{validator}} in the context of data along with some metadata.
#' 
#' 
...
#' \itemize{
#' \item{\code{\link{confront}}}
#' \item{\code{\link{indication-class}}}
#' }
#' @aliases validation  
