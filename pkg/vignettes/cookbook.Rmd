...
I am greatly indebted by [dr Olav ten Bosch](https://github.com/donthebike) for
carefully reviewing the manuscript of version 1.0.1. Any mistakes are of course
...
> values is a member of a set of acceptable combinations [(Di Zio et al , 2015)](https://ec.europa.eu/eurostat/cros/system/files/methodology_for_data_validation_v1.0_rev-2016-06_final.pdf).
...
SDMX landscape, registries, and available APIs.
...
```
There are 13 rules in total. For brevity, we only sho the first rule here.
...
The Statistical Data and Metadata eXchange ([SDMX](https://sdmx.org)) standard
...
information model, such as SDMX-[CSV](https://tools.ietf.org/html/rfc4180),
...
Organisations that at the time of writing (summer 2021) actively offer
automated access to their data (not just metadata) via an SDMX API include
the European Central Bank ([ECB](https://sdw-wsrest.ecb.europa.eu/help/)), 
...
[Eurostat](https://ec.europa.eu/eurostat/web/sdmx-web-services/rest-sdmx-2.1),
the International Labour Organisation ([ILO](https://www.ilo.org/sdmx/index.html)),
the UN Food and Agriculture Organization 
([FAO](http://api.data.fao.org/1.0/esb-rest/sdmx/introduction.html)),
...
and the Italian Office of National Statistics ([ISTAT](https://www.istat.it/it/metodi-e-strumenti/web-service-sdmx)). 
...
[SDMX API cheet
sheet](https://raw.githubusercontent.com/sdmx-twg/sdmx-rest/master/v2_1/ws/rest/docs/rest_cheat_sheet.pdf).
