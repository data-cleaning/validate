...
BMI < 23
```
To read the above rules, you can either copy the above code in a file called ```myrules.txt``` or read it from the text
file that comes installed with the package as in the example below.
```{r}
