...
- Compare multiple versions of your data set as it gets processed step by step during for example data cleaning.

We've added plenty of summarizing and visualizations so you can get a quick and attractive look at the results.
...
expectations you have about it, and the validate package makes it super easy
...
Linear equalities form an important class of validation rules. To prevent equalities to be strictly tested, there is an option called `len.eq.eps` (with default value $10^{-8}$) that allows one to add some slack to these tests.
